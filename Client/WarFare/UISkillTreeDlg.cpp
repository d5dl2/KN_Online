...
{
	if (m_iCurSkillPage == MAX_SKILL_PAGE_NUM)
		return;
...
void CUISkillTreeDlg::ButtonTooltipRender(int iIndex)
{
	...
	case SKILL_DEF_SPECIAL0:
		...
		case CLASS_KA_GUARDIAN:
			toolTipId = IDS_SKILL_INFO_BLADE0;
			break;
		case CLASS_EL_RANGER:
		case CLASS_KA_HUNTER:
		case CLASS_EL_ASSASIN:
		case CLASS_KA_PENETRATOR:
			toolTipId = IDS_SKILL_INFO_RANGER0;
			break;
		case CLASS_EL_CLERIC:
		case CLASS_KA_SHAMAN:
		case CLASS_EL_DRUID:
		case CLASS_KA_DARKPRIEST:
			toolTipId = IDS_SKILL_INFO_CLERIC0;
			break;
		case CLASS_EL_MAGE:
		case CLASS_KA_SORCERER:
		case CLASS_EL_ENCHANTER:
		case CLASS_KA_NECROMANCER:
			toolTipId = IDS_SKILL_INFO_MAGE0;
			break;
		}
		break;
	...
	case SKILL_DEF_SPECIAL1:
		...
		case CLASS_EL_PROTECTOR:
		case CLASS_KA_GUARDIAN:
			toolTipId = IDS_SKILL_INFO_BLADE1;
			break;
		case CLASS_EL_RANGER:
		case CLASS_KA_HUNTER:
		case CLASS_EL_ASSASIN:
		case CLASS_KA_PENETRATOR:
			toolTipId = IDS_SKILL_INFO_RANGER1;
			break;
		case CLASS_EL_CLERIC:
		case CLASS_KA_SHAMAN:
		case CLASS_EL_DRUID:
		case CLASS_KA_DARKPRIEST:
			toolTipId = IDS_SKILL_INFO_CLERIC1;
			break;
		case CLASS_EL_MAGE:
		case CLASS_KA_SORCERER:
		case CLASS_EL_ENCHANTER:
		case CLASS_KA_NECROMANCER:
			toolTipId = IDS_SKILL_INFO_MAGE1;
			break;
		}
		break;
	...
	case SKILL_DEF_SPECIAL2:
		...
		case CLASS_EL_PROTECTOR:
		case CLASS_KA_GUARDIAN:
			toolTipId = IDS_SKILL_INFO_BLADE2;
			break;
		case CLASS_EL_RANGER:
		case CLASS_KA_HUNTER:
		case CLASS_EL_ASSASIN:
		case CLASS_KA_PENETRATOR:
			toolTipId = IDS_SKILL_INFO_RANGER2;
			break;
		case CLASS_EL_CLERIC:
		case CLASS_KA_SHAMAN:
		case CLASS_EL_DRUID:
		case CLASS_KA_DARKPRIEST:
			toolTipId = IDS_SKILL_INFO_CLERIC2;
			break;
		case CLASS_EL_MAGE:
		case CLASS_KA_SORCERER:
		case CLASS_EL_ENCHANTER:
		case CLASS_KA_NECROMANCER:
			toolTipId = IDS_SKILL_INFO_MAGE2;
			break;
		}
		break;
	...
	case SKILL_DEF_SPECIAL3:
		...
		case CLASS_EL_PROTECTOR:
		case CLASS_KA_GUARDIAN:
			toolTipId = IDS_SKILL_INFO_BLADE3;
			break;
		case CLASS_EL_RANGER:
		case CLASS_KA_HUNTER:
		case CLASS_EL_ASSASIN:
		case CLASS_KA_PENETRATOR:
			toolTipId = IDS_SKILL_INFO_RANGER3;
			break;
		case CLASS_EL_CLERIC:
		case CLASS_KA_SHAMAN:
		case CLASS_EL_DRUID:
		case CLASS_KA_DARKPRIEST:
			toolTipId = IDS_SKILL_INFO_CLERIC3;
			break;
		case CLASS_EL_MAGE:
		case CLASS_KA_SORCERER:
		case CLASS_EL_ENCHANTER:
		case CLASS_KA_NECROMANCER:
			toolTipId = IDS_SKILL_INFO_MAGE3;
			break;
		}
		break;
	}
	::_LoadStringFromResource(toolTipId, szStr);
...
void CUISkillTreeDlg::AllClearImageByName(const std::string& szFN, bool isVisible, bool includeMainImg)
{
	//	CN3UIImage* pImage;
	CN3UIBase* pBase;
	CN3UIButton* pButton;
	...
	for (int i = 0; i < 4; i++)
	{
		...
		if (pBase) pBase->SetVisible(isVisible);
	}
	...
	for (int i = 0; i < 4; i++)
	{
		...
		if (pButton) pButton->SetVisible(isVisible);
	}
}
...
void CUISkillTreeDlg::SetPageInCharRegion()						// 문자 역역에서 현재 페이지 설정..
{
	for (auto const& i : m_Children) {
		CLogWriter::Write(i->m_szID.c_str());
	}
	AllClearImageByName("public", false, true);

	switch (CGameBase::s_pPlayer->m_InfoBase.eNation)
	{

	case NATION_KARUS:			// 카루스..
		AllClearImageByName("hunter", false, true);
		AllClearImageByName("berserker", false, true);
		AllClearImageByName("sorcerer", false, true);
		AllClearImageByName("shaman", false, true);
		AllClearImageByName("Shadow Knight", false, true);
		AllClearImageByName("Berserker Hero", false, true);
		AllClearImageByName("Elemental Lord", false, true);
		AllClearImageByName("Shadow Bane", false, true);
		...
		case CLASS_KA_WIZARD:
		case CLASS_KA_PRIEST:
			AllClearImageByName("public", true, true);
			break;

		case CLASS_KA_BERSERKER:
			AllClearImageByName("berserker", true, true);
			break;

		case CLASS_KA_HUNTER:
			AllClearImageByName("hunter", true, true);
			break;

		case CLASS_KA_SORCERER:
			AllClearImageByName("sorcerer", true, true);
			break;

		case CLASS_KA_SHAMAN:
			AllClearImageByName("shaman", true, true);
			break;

		case CLASS_KA_GUARDIAN:
			AllClearImageByName("Berserker Hero", true, true);
			AllClearImageByName("berserker", true, false);
			break;

		case CLASS_KA_PENETRATOR:
			AllClearImageByName("Shadow Bane", true, true);
			AllClearImageByName("hunter", true, false);
			break;

		case CLASS_KA_NECROMANCER:
			AllClearImageByName("Elemental Lord", true, true);
			AllClearImageByName("sorcerer", true, false);
			break;

		case CLASS_KA_DARKPRIEST:
			AllClearImageByName("Shadow Knight", true, true);
			AllClearImageByName("shaman", true, false);
			break;
		}
		break;

	case NATION_ELMORAD:		// 엘모라도..
		AllClearImageByName("ranger", false, true);
		AllClearImageByName("blade", false, true);
		AllClearImageByName("mage", false, true);
		AllClearImageByName("cleric", false, true);
		AllClearImageByName("Blade Master", false, true);
		AllClearImageByName("kasar hood", false, true);
		AllClearImageByName("Arc Mage", false, true);
		AllClearImageByName("Paladin", false, true);
		...
		case CLASS_EL_RANGER:
			AllClearImageByName("ranger", true, true);
			break;

		case CLASS_EL_BLADE:
			AllClearImageByName("blade", true, true);
			break;

		case CLASS_EL_MAGE:
			AllClearImageByName("mage", true, true);
			break;

		case CLASS_EL_CLERIC:
			AllClearImageByName("cleric", true, true);
			break;

		case CLASS_EL_PROTECTOR:
			AllClearImageByName("Blade Master", true, true);
			AllClearImageByName("blade", true, false);
			break;

		case CLASS_EL_ASSASIN:
			AllClearImageByName("kasar hood", true, true);
			AllClearImageByName("ranger", true, false);
			break;

		case CLASS_EL_ENCHANTER:
			AllClearImageByName("Arc Mage", true, true);
			AllClearImageByName("mage", true, false);
			break;

		case CLASS_EL_DRUID:
			AllClearImageByName("Paladin", true, true);
			AllClearImageByName("cleric", true, false);
			break;
