...
public:	
	...
	static  void CustomResize(CN3UIBase* ui, int leftOffset, int topOffset)
	{
		ui->MoveOffset(leftOffset, topOffset);
		ui->SetSize(ui->GetWidth() - leftOffset, ui->GetHeight() - topOffset);
	}
